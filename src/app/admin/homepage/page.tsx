...
export default function AdminHomepagePage() {
  ...
  const [btnModelo, setBtnModelo] = useState('Seja Pupilo')
  const [destaquesLabel, setDestaquesLabel] = useState('Destaques')
  const [destaquesTitulo, setDestaquesTitulo] = useState('Pupilos em Evidência')
  const [catalogoLabel, setCatalogoLabel] = useState('Nosso Catálogo')
  const [ctaTitulo, setCtaTitulo] = useState('Quer fazer parte?')
  const [ctaTexto, setCtaTexto] = useState('Cadastre-se como pupilo e conecte-se com oportunidades profissionais.')
