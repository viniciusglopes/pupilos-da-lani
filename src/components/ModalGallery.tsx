...
export default function ModalGallery({ pessoa, isOpen, onClose }: ModalGalleryProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-4 bg-white overflow-hidden">
        {/* Header */}
        ...
        {fotos.length > 0 ? (
          <div className="flex h-[75vh]">
            ...
            {/* Sidebar */}
            <div className="w-72 border-l border-gray-200 p-6 overflow-y-auto">
              {fotos.length > 1 && (
                <div className="mb-6">
          ...
          <div className="h-96 flex items-center justify-center bg-gray-50">
            <p className="text-gray-400 text-sm tracking-widest uppercase">Sem fotos disponíveis</p>
          </div>
        )}
      </div>
    </div>
